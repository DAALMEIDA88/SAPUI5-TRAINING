		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Aplicación prueba 1",
									"targetURL": "#logaligroupprueba1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligroupprueba1-display": {
								"semanticObject": "logaligroupprueba1",
								"action": "display",
								"description": "App Fiori Test",
								"title": "Aplicación prueba 1",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.prueba1",
									"url": sap.ui.require.toUrl("logaligroup/prueba1")
								}
							}
						}
					}
